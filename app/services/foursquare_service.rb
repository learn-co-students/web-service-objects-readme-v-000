class FoursquareService
  ...
  # We pass in system data as arguments in these methods because it's not the reponsibility of the Web Service object to know where to get system data. That's the responsibility of the controller.
