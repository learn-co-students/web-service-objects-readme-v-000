class FoursquareService
  ...
  def venues(client_id, client_secret, zipcode)
    ...
    if @resp.success?
      res = {'venues': body["response"]["venues"]}
    else
      res = {'error': body["meta"]["errorDetail"]}
    end

    rescue Faraday::TimeoutError
      res = {'error': "There was a timeout. Please try again."}
